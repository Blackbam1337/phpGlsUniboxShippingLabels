...
abstract class Gls_Unibox_Model_Label_Abstract 
{
	...
	protected function nationalDeliveryInformation($countryCode,$before) {
		...
		if($before == true) {
			if ($countryCode == "CH") {
				...
				$item = new Varien_Object(); $item->setTag('static')->setValue('SI+NOM')->setPosx(80)->setPosy(123)->setItem( (new Gls_Unibox_Model_Label_Item_Font())->setSize(6)->setRotation(90) ); $this->data->addItem($item); $item = null;	
				$item = new Varien_Object(); $item->setTag('690')->setValue(null)->setPosx(8)->setPosy(67)->setItem( (new Gls_Unibox_Model_Label_Item_Barcode())->setType('Code128')->setHeight(15)->setBarThickWidth(2)->setBarThinWidth(1)->setFactor(2.5) ); $this->data->addItem($item); $item = null;		
				$item = new Varien_Object(); $item->setTag('692')->setValue(null)->setPosx(31)->setPosy(88)->setItem( (new Gls_Unibox_Model_Label_Item_Font())->setSize(7)->setFace('bold') ); $this->data->addItem($item); $item = null;	

				$item = new Varien_Object(); $item->setTag('static')->setValue('0509')->setPosx(9)->setPosy(124)->setItem( (new Gls_Unibox_Model_Label_Item_Barcode())->setType('Code128')->setHeight(10)->setBarThickWidth(2)->setBarThinWidth(1)->setFactor(2) ); $this->data->addItem($item); $item = null;		
				$item = new Varien_Object(); $item->setTag('static')->setValue('1307')->setPosx(48)->setPosy(124)->setItem( (new Gls_Unibox_Model_Label_Item_Barcode())->setType('Code128')->setHeight(10)->setBarThickWidth(2)->setBarThinWidth(1)->setFactor(2) ); $this->data->addItem($item); $item = null;			
			}
			if ($countryCode == "GB") {
					
				$item = new Varien_Object(); $item->setTag('600')->setValue(null)->setPosx(9)->setPosy(63.5)->setItem( (new Gls_Unibox_Model_Label_Item_Barcode())->setType('Code128')->setHeight(21)->setBarThickWidth(3)->setBarThinWidth(1)->setFactor(2.2) ); $this->data->addItem($item); $item = null;		
				...
				$item = new Varien_Object(); $item->setTag('601')->setValue(null)->setPosx(13)->setPosy(125)->setItem( (new Gls_Unibox_Model_Label_Item_Font())->setSize(22)->setFace('bold') ); $this->data->addItem($item); $item = null;	
				...
				$item = new Varien_Object(); $item->setTag('603')->setValue(null)->setPosx(40)->setPosy(120)->setItem( (new Gls_Unibox_Model_Label_Item_Barcode())->setType('Code128')->setHeight(11)->setBarThickWidth(3)->setBarThinWidth(1)->setFactor(2.2) ); $this->data->addItem($item); $item = null;			
				$item = new Varien_Object(); $item->setTag('603')->setValue(null)->setPosx(60)->setPosy(132.5)->setItem( (new Gls_Unibox_Model_Label_Item_Font())->setSize(5)->setFace('bold') ); $this->data->addItem($item); $item = null;	
				
				}

			if ($countryCode == "SE") {
				$item = new Varien_Object(); $item->setTag('660')->setValue(null)->setPosx(7.5)->setPosy(65)->setItem( (new Gls_Unibox_Model_Label_Item_Barcode())->setType('Code128')->setHeight(18.5)->setBarThickWidth(2)->setBarThinWidth(1)->setFactor(2.4) ); $this->data->addItem($item); $item = null;		
			...
			if ($countryCode == "NL") {
				$item = new Varien_Object(); $item->setTag('620')->setValue(null)->setPosx(2)->setPosy(64)->setItem( (new Gls_Unibox_Model_Label_Item_Barcode())->setType('Code25interleaved')->setHeight(16.5)->setBarThickWidth(3)->setBarThinWidth(1)->setFactor(2.9) ); $this->data->addItem($item); $item = null;		
				$item = new Varien_Object(); $item->setTag('620')->setValue(null)->setPosx(31)->setPosy(88.5)->setItem( (new Gls_Unibox_Model_Label_Item_Font())->setSize(7)->setFace('bold') ); $this->data->addItem($item); $item = null;	
			}			
	...
	protected function insertDefaults(){
		...
		$item = new Varien_Object(); $item->setTag('310')->setValue(null)->setPosx(24.5)->setPosy(6.5)->setItem( (new Gls_Unibox_Model_Label_Item_Font())->setSize(28)->setFace('invert') ); $this->data->addItem($item); $item = null;
		...
		$item = new Varien_Object(); $item->setTag('101')->setValue(null)->setPosx(72)->setPosy(6.5)->setItem( (new Gls_Unibox_Model_Label_Item_Font())->setSize(28)->setFace('invert') ); $this->data->addItem($item); $item = null;
