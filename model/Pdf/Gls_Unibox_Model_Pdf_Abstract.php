...
abstract class Gls_Unibox_Model_Pdf_Abstract extends Mage_Core_Model_Abstract
{
	...
	public function __construct(){
		if( Config::$glsbox_label_beginx != '' && (int) Config::$glsbox_label_beginx >=0 ) { $startpunktX = (int) Config::$glsbox_label_beginx; } else { $startpunktX = 0; }
		if( Config::$glsbox_label_beginy != '' && (int) Config::$glsbox_label_beginy >=0 ) { $startpunktY = (int) Config::$glsbox_label_beginy; } else { $startpunktY = 0; }
		...
		if( Config::$glsbox_label_papersize != 'A4' && Config::$glsbox_label_papersize != 'A5' ) { $lettersize = Zend_Pdf_Page::SIZE_A4; }
		else { if ( Config::$glsbox_label_papersize == 'A4' ) {$lettersize = Zend_Pdf_Page::SIZE_A4;} if(Config::$glsbox_label_papersize == 'A5') { $lettersize = '420.94:595.28'; } }
